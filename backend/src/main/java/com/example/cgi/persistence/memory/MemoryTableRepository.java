...
public class MemoryTableRepository implements TableRepository{
    ...
    private void seed() {
        ...
        add(new Table(6,2, Zone.TERRACE, EnumSet.of(Preference.WINDOW), 520, 100, Set.of(7L)));
        add(new Table(7,4, Zone.TERRACE, EnumSet.of(Preference.WINDOW), 640, 100, Set.of(6L)));

        add(new Table(8,6, Zone.TERRACE, EnumSet.noneOf(Preference.class), 580, 220, Set.of()));

        add(new Table(9,8, Zone.PRIVATE_ROOM, EnumSet.of(Preference.QUIET), 560, 360, Set.of(10L)));
        add(new Table(10,4, Zone.PRIVATE_ROOM, EnumSet.of(Preference.QUIET), 720, 360, Set.of(9L)));
    }
